...
<html class="light" lang="en">
  <head>
    ...
    <style>
      ...
      .brush-separator {
        height: 16px;
        background-image: url("data:image/svg+xml,%3Csvg width='1000' height='20' viewBox='0 0 1000 20' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M0 10C50 5 100 15 150 10C200 5 250 15 300 10C350 5 400 15 450 10C500 5 550 15 600 10C650 5 700 15 750 10C800 5 850 15 900 10C950 5 1000 15 1000 10' stroke='%23a5ccdf' stroke-width='4' stroke-linecap='round'/%3E%3C/svg%3E");
  ...
  <body class="bg-background font-body text-on-background selection:bg-secondary-container selection:text-on-secondary-container relative dot-grid">
    ...
    <header class="fixed top-0 left-0 right-0 z-50 bg-[#fef8f4]/80 dark:bg-slate-900/80 backdrop-blur-md">
      <nav class="flex justify-between items-center w-full px-8 py-4 max-w-7xl mx-auto">
        <div class="text-2xl font-bold text-[#2F4156] dark:text-[#fef8f4] tracking-tighter flex items-center gap-2">
          <span class="material-symbols-outlined text-secondary">collections_bookmark</span> ChiikaMart
        </div>
    ...
    <main class="pt-24 relative z-10 overflow-hidden">
      ...
      <section class="relative px-6 py-12 md:py-20 max-w-7xl mx-auto">
        <div class="flex flex-col lg:flex-row items-center gap-12">
          <div class="w-full lg:w-1/2 space-y-8 z-10 text-center lg:text-left relative">
            ...
            <div class="inline-block px-4 py-1 bg-primary text-on-primary rounded-full transform rotate-1 text-xs font-bold tracking-widest uppercase relative shadow-sm"> Welcome to our Adoption Center </div>
            <h1 class="text-5xl md:text-7xl font-extrabold text-primary tracking-tighter leading-tight"> Your New Best <br />
              <span class="text-secondary italic">Friends</span> Await
            </h1>
            <p class="text-lg text-on-surface-variant max-w-md mx-auto lg:mx-0 leading-relaxed"> Step into our cozy scrapbook corner and find a tiny companion to join your daily adventures. Every plush has a story, and every story needs a home. </p>
            <div class="flex flex-wrap justify-center lg:justify-start gap-4">
              <button class="px-8 py-4 bg-gradient-to-br from-secondary to-secondary-container text-on-secondary-container rounded-full font-bold shadow-lg hover:shadow-xl transition-all active:scale-95" onclick="redirectFunc(3)"> Start Adopting </button>
              <button class="px-8 py-4 bg-surface-container-highest text-primary rounded-full font-bold hover:bg-surface-variant transition-all" onclick="redirectFunc(2)"> Learn More </button>
            </div>
          </div>
      ...
      <section class="relative px-6 py-20 md:py-32 max-w-7xl mx-auto overflow-visible">
        <div class="flex flex-col md:flex-row items-center gap-16">
          <div class="w-full md:w-5/12 space-y-6 z-20">
            <div class="inline-block px-5 py-1.5 bg-secondary-container text-on-secondary-container rounded-lg transform -rotate-3 text-xs font-black tracking-[0.2em] uppercase shadow-sm sticker-outline"> ✨ Sticker Sheet Favorite ✨ </div>
            <h2 class="text-6xl md:text-8xl font-playful text-primary leading-none -rotate-1 font-bold"> Ultra Soft <br />
              <span class="text-secondary">Usagi</span>
            </h2>
            <p class="text-2xl font-handwritten text-on-surface-variant leading-relaxed max-w-sm"> This limited edition jumbo plushie is basically a cloud you can hold. Look at those cheeks! </p>
            <div class="pt-4 flex flex-col gap-6">
              ...
              <button class="w-fit px-10 py-5 bg-primary text-on-primary rounded-xl font-handwritten text-2xl shadow-xl hover:shadow-2xl transition-all active:scale-95 sticker-outline -rotate-2"> Add to Scrapbook </button>
            </div>
          </div>
          <div class="w-full md:w-7/12 relative flex justify-center items-center">
            ...
            <div class="relative transform rotate-2 hover:rotate-0 transition-transform duration-500 z-20">
              ...
              <div class="polaroid-frame rounded-sm border border-surface-variant/20">
                ...
                <div class="mt-6 text-center font-handwritten text-on-surface-variant/60 text-lg"> Captured in the Wild 📸 05.2024 </div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div class="group cursor-pointer">
              <div class="bg-surface-container-lowest p-4 rounded-3xl transition-transform group-hover:scale-105 group-hover:-rotate-2 shadow-sm relative border border-surface-variant/50">
                <div class="absolute -top-3 left-1/2 -translate-x-1/2 washi-tape-beige w-12 h-6 rotate-2 opacity-60"></div>
                <div class="aspect-square bg-secondary-container/20 rounded-2xl flex items-center justify-center mb-4 overflow-hidden p-2">
                  <img alt="Keychain" class="w-full h-full object-contain" src="../images/Chiikawa_keychain.png" style="filter: drop-shadow(0px 0px 3px white) drop-shadow(0px 0px 3px white) drop-shadow(0px 0px 3px white);" />
                </div>
                <span class="text-center block font-bold text-primary">Keychain</span>
              </div>
            </div>
            <div class="group cursor-pointer">
              <div class="bg-surface-container-lowest p-4 rounded-3xl transition-transform group-hover:scale-105 group-hover:rotate-2 shadow-sm relative border border-surface-variant/50">
                <div class="absolute -top-3 left-1/2 -translate-x-1/2 washi-tape-teal w-12 h-6 -rotate-2 opacity-60"></div>
                <div class="aspect-square bg-secondary-container/20 rounded-2xl flex items-center justify-center mb-4 overflow-hidden p-2">
                  <img alt="Small" class="w-full h-full object-contain" src="../images/Chiikawa_small2.png" style="filter: drop-shadow(0px 0px 3px white) drop-shadow(0px 0px 3px white) drop-shadow(0px 0px 3px white);" />
                </div>
                <span class="text-center block font-bold text-primary">Small</span>
              </div>
            </div>
            <div class="group cursor-pointer">
              <div class="bg-surface-container-lowest p-4 rounded-3xl transition-transform group-hover:scale-105 group-hover:-rotate-2 shadow-sm relative border border-surface-variant/50">
                <div class="absolute -top-3 left-1/2 -translate-x-1/2 washi-tape-beige w-12 h-6 rotate-1 opacity-60"></div>
                <div class="aspect-square bg-secondary-container/20 rounded-2xl flex items-center justify-center mb-4 overflow-hidden p-2">
                  <img alt="Medium" class="w-full h-full object-contain" src="../images/Hachiware_medium.png" style="filter: drop-shadow(0px 0px 3px white) drop-shadow(0px 0px 3px white) drop-shadow(0px 0px 3px white);" />
                </div>
                <span class="text-center block font-bold text-primary">Medium</span>
              </div>
            </div>
            <div class="group cursor-pointer">
              <div class="bg-surface-container-lowest p-4 rounded-3xl transition-transform group-hover:scale-105 group-hover:rotate-2 shadow-sm relative border border-surface-variant/50">
                <div class="absolute -top-3 left-1/2 -translate-x-1/2 washi-tape-teal w-12 h-6 -rotate-1 opacity-60"></div>
                <div class="aspect-square bg-secondary-container/20 rounded-2xl flex items-center justify-center mb-4 overflow-hidden p-2">
                  <img alt="Jumbo" class="w-full h-full object-contain" src="../images/Usagi_jumbo.png" style="filter: drop-shadow(0px 0px 3px white) drop-shadow(0px 0px 3px white) drop-shadow(0px 0px 3px white);" />
                </div>
                <span class="text-center block font-bold text-primary">Jumbo</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="max-w-5xl mx-auto px-6 mb-24 relative">
        ...
        <div class="bg-secondary-container/20 backdrop-blur-md border border-white/50 rounded-[3rem] p-12 text-center relative overflow-hidden shadow-xl dashed-outline">
          ...
          <h2 class="text-3xl font-extrabold text-primary mb-4 relative inline-block"> Join the Collector's Club <div class="absolute -bottom-2 left-0 w-full brush-separator h-2 opacity-40"></div>
          </h2>
    ...
    <footer class="bg-[#f3ede9]/80 backdrop-blur-md dark:bg-slate-950 w-full rounded-t-[3rem] mt-12 overflow-hidden relative">
      ...
      <div class="flex flex-col items-center justify-center w-full py-12 px-6 space-y-6 relative z-10">
        ...
        <p class="text-[#2F4156] dark:text-[#bee6f9] font-['Plus_Jakarta_Sans'] text-sm tracking-wide text-center"> © 2024 ChiikaMart Adoption Center. Handcrafted with love. </p>
      </div>
    </footer>
