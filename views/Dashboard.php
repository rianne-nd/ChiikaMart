<?php
    ...
    $totalSales = $usermanagement->getTotalSalesRevenue();
    $totalOrders = $usermanagement->getTotalOrders();
    $lowStock = $usermanagement->getLowStockCount();
    $outOfStock = $usermanagement->getOutOfStockCount();
    $totalUsers = $usermanagement->getTotalUsers();
    $mostWishlisted = $usermanagement->getMostWishlisted();
    $averageRating = $usermanagement->getAverageRating();
            ...
            <div class="space-y-6">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-6">
                    <div class="bg-surface-container-lowest rounded-3xl p-6 relative shadow-[0px_20px_40px_rgba(47,65,86,0.04)] overflow-hidden group">
                        ...
                        <h3 class="text-3xl font-extrabold text-on-primary-fixed relative z-10">₱ <?= number_format($totalSales['total_sales'] ?? 0, 2) ?></h3>
                    </div>
                    ...
                    <div class="bg-surface-container-lowest rounded-3xl p-6 relative shadow-[0px_20px_40px_rgba(47,65,86,0.04)] overflow-hidden group">
                        ...
                        <h3 class="text-3xl font-extrabold text-on-primary-fixed relative z-10"><?= $totalOrders['total_orders'] ?? 0 ?></h3>
                    </div>
                    ...
                    <div class="bg-surface-container-lowest rounded-3xl p-6 relative shadow-[0px_20px_40px_rgba(47,65,86,0.04)] overflow-hidden group">
                        ...
                        <h3 class="text-3xl font-extrabold text-on-primary-fixed relative z-10"><?= $totalUsers['total_users'] ?? 0 ?></h3>
                    </div>
                    ...
                    <div class="bg-surface-container-lowest rounded-3xl p-6 relative shadow-[0px_20px_40px_rgba(47,65,86,0.04)] overflow-hidden group">
                        ...
                        <h3 class="text-3xl font-extrabold text-on-primary-fixed relative z-10"><?= number_format($averageRating['avg_rating'] ?? 0, 1) ?> <span class="text-lg font-medium text-outline-variant">/ 5.0</span></h3>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div class="bg-surface-container-lowest rounded-3xl p-6 relative shadow-[0px_20px_40px_rgba(47,65,86,0.04)] border border-surface-variant/50">
                        ...
                        <h3 class="text-xl font-extrabold text-on-primary-fixed mt-2"><?= $mostWishlisted['productName'] ?? 'No Data' ?></h3>
                        <p class="text-sm font-medium opacity-70"><?= $mostWishlisted['wishlist_count'] ?? 0 ?> wishlists</p>
                    </div>
                    ...
                    <div class="bg-[#fff8eb] rounded-3xl p-6 relative shadow-[0px_20px_40px_rgba(47,65,86,0.02)] border-2 border-dashed border-[#fcd34d]/50">
                        ...
                        <h3 class="text-3xl font-extrabold text-[#92400e] mt-2"><?= $lowStock['low_stock_count'] ?? 0 ?> <span class="text-sm font-medium opacity-70">Items < 5</span></h3>
                    </div>
